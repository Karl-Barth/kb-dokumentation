...
**textstructure:** [body](body.md) "Enthält den gesamten Textkörper eines KBGA-Dokuments." [closer](closer.md) "Schlussformel eines Briefes (Gruss, Unterschrift, Datum)." [div](div.md) "Gliederungseinheit eines Textes. Der @type unterscheidet Tex" [opener](opener.md) "fasst Datumszeile, Verfasserangabe, Anredeformel und ähnlich" [postscript](postscript.md) "enthält einen Nachtrag (Postskriptum), z. B. zu einem Brief."
